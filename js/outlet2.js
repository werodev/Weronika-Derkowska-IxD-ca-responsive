...
const productsContainer = document.querySelector("#products3");
...
productArray.forEach(function (product) {
    if (product.outlet === 1) {
        productsContainer.innerHTML +=
            ...
            <div class="discount"><img src="./img/icons/discount.png" title="discount" alt="discount"></div>
            <h3>${product.name}</h3>
            <h4>${product.price} NOK</h4>
            <button class="more" data-product=${product.id}>Go to product</button>
            </div>
            `;
    }
})
